...
DRIVER_PATH = r'C:\Users\q\PycharmProjects\ImageScrapper\ImageScrapper\chromedriver.exe'
...
"""---TASKS---
1.try to store all of these images in mongoDB
2.try to implement it with class and object
coding standard
3.write a func for fetch all the iamges based on there name form data base
4.try to modify a code so that i will first search in data base and check if images are available
--for a respective search if not then only scrap--try to not download same image
"""

# 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
"""
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
